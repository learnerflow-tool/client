...
function AnnotationController(
  ...
  var newlyCreatedByConfusingButton;
  var newlyCreatedByHelpButton;
  var newlyCreatedByErrataButton;
  var newlyCreatedByLikeButton;
  ...
  function init() {
    ...
    newlyCreatedByConfusingButton = vm.annotation.$conf || false;
    newlyCreatedByHelpButton = vm.annotation.$help || false;
    newlyCreatedByErrataButton = vm.annotation.$errata|| false;
    newlyCreatedByLikeButton = vm.annotation.$like|| false;
    // end Shaveen
    ...
    if (newlyCreatedByConfusingButton == true) { vm.annotation.tags = ['#confusing'];} 
      else if (newlyCreatedByHelpButton == true) { vm.annotation.tags = ['#help'];} 
      else if (newlyCreatedByErrataButton == true) { vm.annotation.tags = ['#errata'];} 
      else if (newlyCreatedByLikeButton == true) { vm.annotation.tags = ['#interesting'];} 

    if (!Array.isArray(vm.annotation.tags)) {
      vm.annotation.tags = [];
      // added Shaveen 02 Nov 2016 
      /*  if (newlyCreatedByHighlightButton) { vm.annotation.tags = [];}
        else if (newlyCreatedByConfusingButton) { vm.annotation.tags = ['#confusing'];} 
        else if (newlyCreatedByHelpButton) { vm.annotation.tags = ['#help'];} 
        else if (newlyCreatedByErrataButton) { vm.annotation.tags = ['#errata'];} 
          else { vm.annotation.tags = [];} */
